...
SECRET_KEY = "django-insecure-=!9xit6t0&%$h*b=$(g2c7@@=jaq@%f)3j*s=1)4$yzb82&lc&"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "customer_service_db"),
        "USER": os.environ.get("DB_USER", "bookstore"),
        "PASSWORD": os.environ.get("DB_PASSWORD", "bookstore"),
        "HOST": os.environ.get("DB_HOST", "customer-service-db"),
