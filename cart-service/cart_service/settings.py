...
SECRET_KEY = "django-insecure-+7+a&_i30&xsm%=(+diq(60pg5^k7f88*6jn7rl7bc7gwcpvt^"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "cart_service_db"),
        "USER": os.environ.get("DB_USER", "bookstore"),
        "PASSWORD": os.environ.get("DB_PASSWORD", "bookstore"),
        "HOST": os.environ.get("DB_HOST", "cart-service-db"),
