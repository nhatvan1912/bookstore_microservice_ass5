...
SECRET_KEY = "django-insecure-!bq#u&*^_k83g^b@&@#yy10e^2(nghqa6_h5k8snf_b(13u!$)"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "pay_service_db"),
        "USER": os.environ.get("DB_USER", "bookstore"),
        "PASSWORD": os.environ.get("DB_PASSWORD", "bookstore"),
        "HOST": os.environ.get("DB_HOST", "pay-service-db"),
