...
SECRET_KEY = "django-insecure-=z#szk-c3@9+t9(52i9wcl%pe5(s+otja33s6kce6uj)pj-#+r"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "comment_rate_service_db"),
        "USER": os.environ.get("DB_USER", "bookstore"),
        "PASSWORD": os.environ.get("DB_PASSWORD", "bookstore"),
        "HOST": os.environ.get("DB_HOST", "comment-rate-service-db"),
